...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a
   build.
2. Update any pertinent documentation with details of your changes. This includes new environment
   variables, useful file locations and configuration parameters.

All contributors and contributions agree to abide by, and be bound by, the Code of Conduct, described below.
